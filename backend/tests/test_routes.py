...
class TestHealth:
    def test_health_returns_ok(self, client):
        ...
        # for polled_radar_probation and POLLED_RADAR_PROBATION_ENABLED, for
        # polled_radar_polling and POLLED_RADAR_POLLING_ENABLED, and for
        # polled_radar_registration and POLLED_RADAR_REGISTRATION_ENABLED.
        ...
        assert isinstance(body["polled_radar_registration"], bool)
        assert set(body) == {
            "status",
            "synthetic_fleet",
            "polled_radar_probation",
            "polled_radar_polling",
            "polled_radar_registration",
        }
