          ...
          {!nothingLoaded(pageFetch) && (
            ...
            >
              {archives.map((file, i) => {
                ...
                // The segment before the filename, as the route and the Data Explorer read it.
                const segment = parts.length >= 4 ? parts[parts.length - 2] : "";
                const ref = segment.slice(segment.indexOf("=") + 1);
